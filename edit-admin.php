...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE administrators SET username=%s, admin_uid=%s, power=%s WHERE id=%s",
...
$colname_server_admins = "-1";
if (isset($_GET['id'])) {
  $colname_server_admins = $_GET['id'];
}
mysql_select_db($database_ststsconfig, $ststsconfig);
$query_server_admins = sprintf("SELECT * FROM administrators WHERE id = %s", GetSQLValueString($colname_server_admins, "int"));
  ...
  <div class="main_container">
    <div class="col-md-3 left_col">
      <div class="left_col scroll-view">
        <div class="navbar nav_title"> <a href="/" class="site_title"><i class="fa fa-line-chart"></i> <span>Cap | Edit Admin</span></a> </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-6">
                  <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                    <p>
                      ...
                      <input type="text" id="username" class="form-control" name="username" value="<?php echo htmlentities($row_server_admins['username'], ENT_COMPAT, 'UTF-8'); ?>" required />
                    </p>
                    <p>
                      <label for="admin_uid">Admin UID * :</label>
                      <input type="text" id="admin_uid" class="form-control" name="admin_uid" value="<?php echo htmlentities($row_server_admins['admin_uid'], ENT_COMPAT, 'UTF-8'); ?>" required />
                    </p>
                    <p>
                      <label for="power">Power *:</label>
                      <select id="power" class="form-control" name="power" required>
                        <option value="20" <?php if (!(strcmp(20, htmlentities($row_server_admins['power'], ENT_COMPAT, 'UTF-8')))) {echo "SELECTED";} ?>>20</option>
                        <option value="40" <?php if (!(strcmp(40, htmlentities($row_server_admins['power'], ENT_COMPAT, 'UTF-8')))) {echo "SELECTED";} ?>>40</option>
                        <option value="60" <?php if (!(strcmp(60, htmlentities($row_server_admins['power'], ENT_COMPAT, 'UTF-8')))) {echo "SELECTED";} ?>>60</option>
                        <option value="80" <?php if (!(strcmp(80, htmlentities($row_server_admins['power'], ENT_COMPAT, 'UTF-8')))) {echo "SELECTED";} ?>>80</option>
                        <option value="100" <?php if (!(strcmp(100, htmlentities($row_server_admins['power'], ENT_COMPAT, 'UTF-8')))) {echo "SELECTED";} ?>>100</option>
                      </select>
                    </p>
                    <p> <br />
                      <input type="submit" class="btn btn-primary pull-right" value="Save">
                    </p>
                    <input type="hidden" name="id" value="<?php echo $row_server_admins['id']; ?>">
